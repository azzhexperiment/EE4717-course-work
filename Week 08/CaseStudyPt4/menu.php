...
$priceEndlessJustJava;
$priceSingleCafeAuLait;
$priceDoubleCafeAuLait;
$priceSingleIcedCappuccino;
$priceDoubleIcedCappuccino;
					...
					<table class="menu">
						...
						<tr class="menu-item">
							...
							<td class="description">
								...
								<div>
									<input type="radio" name="icedCappuccino" id="single-iced-cappuccino" value="$priceSingleIcedCappuccino">
									Single $4.75

									<input type="radio" name="icedCappuccino" id="double-iced-cappuccino" value="$priceDoubleIcedCappuccino">
									Double $5.75
								</div>
							</td>
							<td class="qty">
